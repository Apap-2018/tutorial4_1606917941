...
public class PilotController {
	...
	private String view(String licenseNumber,Model model) {
		PilotModel pilot = pilotService.getPilotDetailByLicenseNumber(licenseNumber);
		List<FlightModel> listFlight = pilotService.getListFlightByLicenseNumber(licenseNumber);
		model.addAttribute("pilot", pilot);
		model.addAttribute("listflight", listFlight);
		model.addAttribute("licensenumber", pilot.getLicenseNumber());
		return "view-pilot";
	}
